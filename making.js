...
// Do not edit the code below.
var myFavoriteNumbers = [4,8,12,16,20,24,30,40];
// Do not edit the code above.
...
if (myFavoriteNumbers.length <7){
  ...
  someNum = myFavoriteNumbers.slice(6,7)
}console.log(someNum)
...
else if (listOfNumbers[i] % 3 !== 0){
  else {console.log('you broke the code')
}
}
//Code Here`/
...
// Do not edit the code above.
switch (letterGrade) {
  case A: console.log('Student is doing excellently')
  case B: console.log('Student is doing well')
  case C: console.log ('student is doing alright')
  case D: console.log ('student is failing')
case F: console.log ('student is failing')
